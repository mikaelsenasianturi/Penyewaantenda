...
TanggalInput = input("Masukkan Tanggal Pemesanan (contoh: 22-06-2024): ")
FormatAwal = '%d-%m-%Y'
...
if DendaKeterlambatan == "0" :
    ...
    HargaDenda = ((int(Harga)*0.1)+ int(Harga))*int(DendaKeterlambatan)
...
CustBayar = int(input("Nominal Pembayaran:"))
...
print(f"Denda Keterlambatan : Rp {HargaDenda:,.2f}")
print(f"Total Harga         : Rp {TotalHarga:,.2f}")
print(f"Pembayaran          : Rp {CustBayar:,.2f}")
